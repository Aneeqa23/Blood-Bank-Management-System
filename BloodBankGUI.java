...
class BloodInventory {
    ...
    public boolean removeUnit(String unitID) {
        try {
            if (unitID == null || unitID.trim().isEmpty()) return false;

            boolean removed = false;
            for (int i = 0; i < units.size(); i++) {
                BloodUnit u = units.get(i);
                if (u != null && u.getUnitID() != null && u.getUnitID().equals(unitID)) {
                    units.remove(i);
                    removed = true;
            ...
            System.err.println("Error removing blood unit: " + e.getMessage());
            return false;
        }
    }
    ...
    public ArrayList<BloodUnit> searchByType(String type) {
        ...
        try {
            ...
            // Sort by expiry date
            result.sort(new Comparator<BloodUnit>() {
                @Override
                public int compare(BloodUnit u1, BloodUnit u2) {
                    return u1.getExpiryDate().compareTo(u2.getExpiryDate());
                }
            });
        } catch (Exception e) {
    ...
    public ArrayList<BloodUnit> getCompatible(String recipientType) {
        ...
        try {
            if (recipientType == null) return compatible;
            ...
            compatible.sort(new Comparator<BloodUnit>() {
                @Override
                public int compare(BloodUnit u1, BloodUnit u2) {
                    return u1.getExpiryDate().compareTo(u2.getExpiryDate());
                }
            ...
            System.err.println("Error getting compatible blood: " + e.getMessage());
        }
        return compatible;
    }
    ...
    public ArrayList<BloodUnit> getCompatibleWithMessage(String requestedType) {
        try {
            if (requestedType == null) return new ArrayList<>();
            ...
            System.err.println("Error getting compatible blood with message: " + e.getMessage());
    ...
    private String[] getCanReceive(String type) {
        try {
            ...
            switch (type.toUpperCase()) {
                case "A+" -> { 
                    return new String[]{"A+", "A-", "O+", "O-"}; }
                case "A-" -> {
                     return new String[]{"A-", "O-"}; }
                case "B+" -> {
                    return new String[]{"B+", "B-", "O+", "O-"}; }
                case "B-" -> { 
            ...
            System.err.println("Error in getCanReceive: " + e.getMessage());
            return new String[]{};
        }
    }
    ...
    public void removeExpired() {
        try {
            for (int i = 0; i < units.size(); i++) {
                BloodUnit u = units.get(i);
                if (u != null && u.getExpiryDate() != null &&
            ...
            System.err.println("Error removing expired units: " + e.getMessage());
        }
    }
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(fileName))) {
            ...
            while ((line = br.readLine()) != null) {
                try {
                    ...
                    System.err.println("Error parsing line in loadFromFile: " + e.getMessage());
                }
            }
        } catch (FileNotFoundException e) {
        } catch (IOException e) {
...
class Testing {
    ...
    public boolean testBloodUnit(BloodUnit unit) {
        try {
            if (unit == null) {
                System.err.println("Error: Cannot test null blood unit");
                return false;
            }
            ...
            System.err.println("Error testing blood unit: " + e.getMessage());
            return false;
        }
    }
...
class Hemovigilance {
    ...
    public void monitorTransfusion(BloodUnit unit) {
        try {
            if (unit == null) {
                System.err.println("Error: Cannot monitor transfusion for null blood unit");
                return;
            }
            ...
            System.err.println("Error monitoring transfusion: " + e.getMessage());
        }
    }
...
class Admin {
    ...
    public void addDonor(Donor donor, int donationAmount) {
        try {
            if (donor == null) {
                System.err.println("Error: Cannot add null donor");
                return;
            }
            donors.add(donor);
            ...
            System.err.println("Error adding donor: " + e.getMessage());
        }
    }
    ...
    private void autoRegisterDonor(Donor d, int donationAmount) {
        try {
            ...
            String bloodType = (String) JOptionPane.showInputDialog(
                null,
                "Enter donor's blood type:",
            ...
            if (donationAmount < 350 || donationAmount > 500) {
                JOptionPane.showMessageDialog(null, 
                    "Donation amount " + donationAmount + "ml is not safe!\n" +
                    "Safe range is 350-500ml. Registration cancelled.",
            ...
            if (unit != null) {
                if (testing.testBloodUnit(unit)) {
                    ...
                    JOptionPane.showMessageDialog(null,
                        "Donor auto-registered successfully!\n" +
                ...
                JOptionPane.showMessageDialog(null,
                    "Donor not eligible. Registration cancelled.",
                    "Eligibility Failed", JOptionPane.ERROR_MESSAGE);
                donors.remove(d);
            }
        } catch (Exception e) {
            System.err.println("Error in auto-registration: " + e.getMessage());
            JOptionPane.showMessageDialog(null,
                "Error in auto-registration: " + e.getMessage(),
    ...
    public void addRequestor(Requestor r) {
        try {
            if (r == null) {
                System.err.println("Error: Cannot add null requestor");
                return;
            }
            ...
            System.err.println("Error adding requestor: " + e.getMessage());
        }
    }
    ...
    public void issueBlood(Request request) {
        try {
            if (request == null) {
                System.err.println("Error: Cannot issue blood for null request");
                return;
            }
            ...
            if (availableAmount >= neededAmount) {
                ...
                System.err.println("Not enough compatible blood available for request");
            }
        } catch (Exception e) {
            System.err.println("Error issuing blood: " + e.getMessage());
        }
    }
    ...
    private void saveRequestorsToFile() {
        try (PrintWriter pw = new PrintWriter(new FileWriter("requester.csv"))) {
            ...
            System.err.println("Error: Cannot save requestors - file not found");
        } catch (IOException e) {
            System.err.println("Error saving requestors: " + e.getMessage());
        } catch (Exception e) {
            System.err.println("Error saving requestors: " + e.getMessage());
        }
    }
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("requester.csv"))) {
            ...
            while ((line = br.readLine()) != null) {
                try {
                    ...
                    System.err.println("Error parsing line in loadRequestorsFromFile: " + e.getMessage());
                }
            }
        } catch (FileNotFoundException e) {
        } catch (IOException e) {
            System.err.println("Error reading requestor file: " + e.getMessage());
        } catch (Exception e) {
            System.err.println("Error loading requestors: " + e.getMessage());
        }
    }
    ...
    private Requestor findRequestorByCNIC(String cnic) {
        try {
            ...
            System.err.println("Error finding requestor by CNIC: " + e.getMessage());
        }
        return null;
    }
...
public class BloodBankGUI {
   ...
   // Color(128, 0, 128)     - #800080 - Purple
    ...
    private void createRequestPanel() {
        ...
        newFormPanel.add(createFormLabel("Age:"));
    ...
    private void showDonorsView() {
        try {
           ...
           String[] columns = {"Name", "Blood Group", "Health Status", "CNIC", "Blood Amount", "Date", "Eligible"};
   ...
   private void loadDonorsData() {
    try {
        ...
        // Read ALL donations from blood_units.txt
            ...
            try (BufferedReader br = new BufferedReader(new FileReader(bloodUnitsFile))) {
                ...
                while ((line = br.readLine()) != null) {
                    try {
                        ...
                        String bloodType = arr[1];
                        String donationDate = arr[2];  
                        String donorName = arr[4];
                        String donorCnic = arr[5];
                        int donationAmount = Integer.parseInt(arr[6]);
    ...
    try {
        ...
        // Try to load data quietly
        if (admin != null) {
            BloodInventory inventory = admin.getInventory();
            if (inventory != null) {
                ArrayList<BloodUnit> units = inventory.getUnits();
                if (units != null) {
    ...
    if (confirm == JOptionPane.YES_OPTION) {
        try {
            ...
            for (String line : lines) {
                ...
                } else if (line.contains("Not enough compatible")) {
                    guiMessage.append(" ").append(line.trim()).append("\n");
                } else if (line.contains("Available:") && line.contains("Needed:")) {
                    guiMessage.append(" ").append(line.trim()).append("\n");
                }
            }
            ...
            // Only show success message if blood was actually issued
            if (consoleOutput.contains("Blood issued successfully")) {
                JOptionPane.showMessageDialog(mainFrame,
